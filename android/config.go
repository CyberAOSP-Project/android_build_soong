...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Cyber.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.CyberConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Cyber.Specific_camera_parameter_library)
}
